...
namespace WiredBrainCoofee.SpecialCase
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Container<boll>: {Container<bool>.InstanceCount}");
            ...
            var result2= Add(2.6, 3.3);
            Console.WriteLine($"2.6 + 3.3 = {result2}");
